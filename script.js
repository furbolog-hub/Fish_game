...
// Исправлено: увеличенная зона клика и надежная привязка
...
list.innerHTML = 'Игральная кость';
...
state.hasMessageInBottle = true; alert("Послание в бутылке! (Возврат веса)");

} else if (item === "Компас потерянных глубин") {

state.hasCompass = true; alert("Компас! (Управление погодой)");
