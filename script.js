...
const gameHandbook = {
    mechanics: {
        title: "Механики",
        items: {
            "Погода": "Влияет на шанс легендарок, бонусов и появление дебаффов.",
            "Компас": "Позволяет принудительно менять погоду при использовании.",
            "Игральная кость": "Дает случайный бонус к попыткам или множитель улова."
        }
    },
    bonuses: {
        title: "Бонусы",
        items: {
            "Катушка": "+1 попытка",
            "Ласты": "Удваивают итоговый вес улова",
            "Маска": "Позволяет удалить любой предмет из истории",
            "Акваланг": "Умножает вес лучшей пойманной рыбы",
            "Фильтр": "Защищает попытку при ловле хлама"
        }
    },
    debuffs: {
        title: "Дебафы",
        items: {
            "Чайка": "Ворует рыбу из истории",
            "Утка": "Подменяет рыбу на мусор или микро-рыбу",
            "Рак": "Ограничивает вес рыбы до 2.5 кг"
        }
    }
};
